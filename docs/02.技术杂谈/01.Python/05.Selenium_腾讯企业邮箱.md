---
title: Selenium 腾讯企业邮箱自动发信
author: 
  name: Dragon1573
  link: https://github.com/Dragon1573
date: 2022-11-11 13:02:03
permalink: /skill/python/tencent_exmail_with_selenium
---
...
::: center
![image-20221111134019073](./assets/image-20221111134019073.png)
:::
...
::: center
![image-20221111134557473](./assets/image-20221111134557473.png)
:::

执行 `microsoft-edge` ，WSLg 能够自动打开一个浏览器窗口。

::: center
![image-20221111140432449](./assets/image-20221111140432449.png)
:::

::: center
![image-20221111140519358](./assets/image-20221111140519358.png)
:::
...
::: center
![image-20221111140026943](./assets/image-20221111140026943.png)
:::

执行 `msedgedriver` ，能够正常启动驱动程序。

::: center
![image-20221111140614228](./assets/image-20221111140614228.png)
:::
...
::: center
![image-20221111222013000](./assets/image-20221111222013000.png)
:::
...
::: center
![image-20221111224514196](./assets/image-20221111224514196.png)
:::
...
::: center
![image-20221111231833088](./assets/image-20221111231833088.png)
:::
...
::: center
![image-20221111233426248](./assets/image-20221111233426248.png)
:::
...
::: center
![image-20221111233653005](./assets/image-20221111233653005.png)
:::
...
::: center
![image-20221111234751134](./assets/image-20221111234751134.png)
:::
...
<code-group>
  <code-block title="Poetry" activate>
...
::: center
![image-20221111235915025](./assets/image-20221111235915025.png)
:::

好耶 ヾ(✿ﾟ▽ﾟ)ノ 我们成功地发送了邮件，也成功地在另一个邮箱收到了这一封邮件。

::: center
![image-20221112001247635](./assets/image-20221112001247635.png)
:::
